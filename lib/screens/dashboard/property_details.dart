...
class _PropertyDetailsState extends State<PropertyDetails> {
  ...
  Future<void> showMonthPickerModal(BuildContext context) async {
    ...
    await fetchRentInfo(monthToNumber(currentMonth), currentYear);
    await fetchTransactionsList(monthToNumber(currentMonth), currentYear);
    await fetchPendingInfo(monthToNumber(currentMonth));
  }

  bool transactionListLoaded = true;

  Future<void> fetchTransactionsList(int selectedMonth, int selectedYear) async {
  ...
  Future<void> fetchRentInfo(int selectedMonth, int selectedYear) async {
  ...
  Future<void> fetchPendingInfo(int selectedMonth) async {
  ...
  void initState() {
    ...
    fetchRentInfo(DateTime.now().month, currentYear);
    fetchPendingInfo(DateTime.now().month);
    fetchTransactionsList(DateTime.now().month, currentYear);
  }
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: _selectedTabIndex == 0
                              ? mintyGreen.withValues(alpha: 0.1)
                              : Colors.transparent,
                        ...
                        child: Text(
                          ...
                          style:
                              Theme.of(context).textTheme.bodySmall!.copyWith(
                                    color: _selectedTabIndex == 1
                                        ? Colors.red
                                        //   primaryDarkColor.withValues(alpha:0.7)
                                        : Colors.black.withValues(alpha: 0.5),
                                  ),
                        ),
                      ),
